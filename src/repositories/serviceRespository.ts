...
class ServiceRepository{
    ...
    async createAndSave(service_package_id: number, service_date: Date, service_done: number, value: string, service_description: string){
        const service = this.repository.create({service_package_id, service_date, value, service_description, service_done})
